...
class Elavator
{
    ...
    //returns bools of floors to stop on
...
//Call this when arriving at floor to pick people up 
//and update the fact that they were picked up
    ...
    {
        //sleep(1000);
        //cout << "Prev Floor: " << getFloor() << endl;
        //cout << "Going UP" << endl;
        setFloor(getFloor()+1);
        //cout << "Curr Floor: " << getFloor() << " " << endl;
    }
    ...
    vector<int> peopleGetOnandOff(vector<int> peopleOnFloor)
    {
        ...
        if (FloorsToDropOffPeople.at(getFloor()))
        {
            ...
            peopleOnFloor = pickPeopleUp(peopleOnFloor,getDirection());
            PeopleExit();
        }
        return peopleOnFloor;
    }
